...
func (t *SimpleChaincode) pat_query(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *SimpleChaincode) pat_queryone(stub shim.ChaincodeStubInterface, args []string) pb.Response {
